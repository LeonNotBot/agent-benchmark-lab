...
RUNNER_REVISION = "2026-08-03-grok-build-windows-v1.0.1-search-adapter-0.1.3"
...
def write_run_config(
    ...
    config = {
        ...
        "adapter_scope": "force benchmark model; normalize OpenRouter web-search response events; suppress legacy SSE DONE",
