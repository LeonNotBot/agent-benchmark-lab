...
$Script = Join-Path $Root "runner\regrade_kimi_frozen_outputs_v2.py"
...
Write-Host "Starting frozen-output regrade v2..."
...
if ($LASTEXITCODE -ne 0) { throw "Regrade v2 failed with exit code $LASTEXITCODE" }
